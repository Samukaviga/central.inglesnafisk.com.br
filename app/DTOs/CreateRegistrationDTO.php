...
class CreateRegistrationDTO
{
    public function __construct(
        ...
        public readonly ?string $course_1,
        public readonly ?string $course_2,
        public readonly ?string $course_3,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            ...
            course_1: self::nullIfEmpty($data['course_1'] ?? null),
            course_2: self::nullIfEmpty($data['course_2'] ?? null),
            course_3: self::nullIfEmpty($data['course_3'] ?? null),
